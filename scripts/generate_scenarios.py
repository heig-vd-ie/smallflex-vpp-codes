from federation.integrate_time_series import generate_sql_tables_gries, generate_random_discharge_sql
...
if __name__ == "__main__":
    ...
    if not os.path.exists(db_cache_file):
        ...
        generate_random_discharge_sql(restart_interim_data=True, write_sql=db_cache_file_sql)
