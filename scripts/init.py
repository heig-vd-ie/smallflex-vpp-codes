...
class InputSchemaInit:
    ...
    def save(self):
        ...
        model_filename= importlib.resources.files(data_federation).joinpath("input_model/__init__.py")
        model_foldername = importlib.resources.files(data_federation).joinpath("input_model")
