...
def deterministic_second_stage_constraints_with_battery(model: pyo.AbstractModel) -> pyo.AbstractModel:
    model.objective = pyo.Objective(rule=third_stage_objective_with_battery, sense=pyo.maximize)
...
def deterministic_second_stage_constraints_without_battery(model: pyo.AbstractModel) -> pyo.AbstractModel:
    model.objective = pyo.Objective(rule=third_stage_objective_without_battery, sense=pyo.maximize)
    model = third_stage_common_constraints(model)
    return model
