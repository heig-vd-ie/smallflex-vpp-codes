...
class WaterBasin(pt.Model):
    ...
    volume_min: Optional[float] = pt.Field(dtype=pl.Float64, default=0.0, description="Water basin minimum volume in m3")
    ...
    start_volume: float = pt.Field(dtype=pl.Float64, default=0.0, description="Water basin start volume in m3")
