...
LOCATION = Literal["Griessee","Chummbach_Restgebiet","Laengtalbach_Altstafel","Greissbach_Altstafel"]
UUID_REG = r"^[0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$"

class DischargeFlowHistorical(pt.Model):
    ...
    location: LOCATION = pt.Field(dtype=pl.Utf8, constraints=literal_constraint(pt.field, LOCATION), description="River name")
